...
```shell
  ...
  ```
## Access method
Note: To access the FSVR dataset, please sign the [end user license](FSVR/End User License.pdf) and email to yunyi@gnnu.edu.cn. The download link will be provided after completion.



# [MFFLNet](MFFLNet)

- A Multi-Scale Fire Feature Learning Network for Fire Video Recognition
...
- The used datasets are provided in [FSVR](FSVR/End User License.pdf) and [LFVR](https://github.com/yunyi9/LFVR). The train/test splits in both two datasets follow the official procedure. 
